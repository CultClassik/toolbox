# Generated by Powerlevel10k configuration wizard on 2022-02-15 at 18:51 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # goenv                   # go environment (https://github.com/syndbg/goenv) # This looks to be abandoned but would be really nice to have
